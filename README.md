...
- **Two-Party Custody Handshake**: Prevents inventory interception or unilateral dumping. Inbound shipments require explicit mutual acceptance by the authorized recipient.
...
flowchart TD
    ...
    subgraph Web3["Web3 Layer"]
        ...
        ReadRPC["Infura JSON-RPC (Static Network Read-Only)"]
    end

    subgraph Blockchain["Ethereum Sepolia Testnet"]
        Contract["PharmaTree.sol (0x36ea...24D0)"]
        RBAC["Access Control Matrix"]
        Units["Unit Registry & Partitions"]
        Events["Audit Log (UnitCreated, TransferInitiated, etc.)"]
    end

    Admin & Mfr & Handler --> MetaMask
    Public --> VerifyUI
    MetaMask -->|Sign Transactions| Contract
    UI & VerifyUI -->|Fast Parallel Reads| ReadRPC
    ReadRPC --> Contract
...
| **Chain ID** | `11155111` |
| **Contract Address** | [`0x36ea40cb4edc7e304DA1A280480afd16ABb124D0`](https://sepolia.etherscan.io/address/0x36ea40cb4edc7e304DA1A280480afd16ABb124D0) |
| **Deployment Block** | `11671278` |
...
| **Distributor / Handler** | `0xe88a5608B536BCc9d557823234BacA9a00F2540B` | Authorized handler for custody transfer & dispensing |
...
SEPOLIA_CONTRACT_ADDRESS=0x36ea40cb4edc7e304DA1A280480afd16ABb124D0
```

**`frontend/.env.local`**:
```env
NEXT_PUBLIC_PHARMA_TREE_CONTRACT=0x36ea40cb4edc7e304DA1A280480afd16ABb124D0
NEXT_PUBLIC_RPC_URL=https://sepolia.infura.io/v3/<YOUR_INFURA_KEY>
NEXT_PUBLIC_CHAIN_ID=11155111
NEXT_PUBLIC_DEPLOYMENT_BLOCK=11671278
```
